...
TAR["task_alert_relation(由SQL脚本创建)"]
end
SU --> DC
SU --> CT
DC --> CT
...
图表来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L10-L185)
...
图表来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L63-L135)
...
- [DbConnection.java](file://backend/src/main/java/com/fieldcheck/entity/DbConnection.java#L18-L46)
...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L63-L135)
- [CheckTask.java](file://backend/src/main/java/com/fieldcheck/entity/CheckTask.java#L25-L74)
...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L63-L135)
- [TaskExecution.java](file://backend/src/main/java/com/fieldcheck/entity/TaskExecution.java#L51-L52)
- [AuditLog.java](file://backend/src/main/java/com/fieldcheck/entity/AuditLog.java#L41-L48)
