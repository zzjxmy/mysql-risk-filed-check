...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L11-L21)
...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L63-L66)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L83-L84)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L129-L135)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L176-L180)
...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L105-L109)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L39-L40)
...
章节来源
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L1-L8)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L105-L109)
- [01_init_schema.sql](file://mysql/init/01_init_schema.sql#L39-L40)

### 初始化脚本说明
- 数据库创建：若不存在则创建 fieldcheck 库，字符集 utf8mb4，排序规则 utf8mb4_unicode_ci
- 表结构创建：按顺序创建 sys_user、db_connection、check_task、task_execution、risk_result、audit_log、alert_config、whitelist_rule、task_alert_config、task_alert_relation
