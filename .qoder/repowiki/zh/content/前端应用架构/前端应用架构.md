...
- [stores/user.ts](file://frontend/src/stores/user.ts#L1-L60)
- [components/Layout.vue](file://frontend/src/components/Layout.vue#L1-L162)
- [views/auth/Login.vue](file://frontend/src/views/auth/Login.vue#L1-L131)
- [views/Dashboard.vue](file://frontend/src/views/Dashboard.vue#L1-L210)
- [views/task/TaskList.vue](file://frontend/src/views/task/TaskList.vue#L1-L137)
- [views/task/TaskForm.vue](file://frontend/src/views/task/TaskForm.vue#L1-L192)
- [utils/request.ts](file://frontend/src/utils/request.ts#L1-L47)
- [api/auth.ts](file://frontend/src/api/auth.ts#L1-L27)
- [api/connection.ts](file://frontend/src/api/connection.ts#L1-L37)
- [api/risk.ts](file://frontend/src/api/risk.ts#L1-L71)
...
## 架构总览
前端采用“入口 -> 路由 -> 视图 -> API -> 状态”的清晰分层，配合 Element Plus 提供的 UI 能力与 Pinia 进行轻量状态管理，整体架构简洁、职责明确。
...
图表来源
- [router/index.ts](file://frontend/src/router/index.ts#L102-L113)
- [stores/user.ts](file://frontend/src/stores/user.ts#L16-L16)
...
图表来源
- [stores/user.ts](file://frontend/src/stores/user.ts#L28-L41)
- [api/auth.ts](file://frontend/src/api/auth.ts#L16-L18)
...
图表来源
- [utils/request.ts](file://frontend/src/utils/request.ts#L4-L47)
...
章节来源
- [views/Dashboard.vue](file://frontend/src/views/Dashboard.vue#L1-L210)
- [api/risk.ts](file://frontend/src/api/risk.ts#L47-L49)
...
图表来源
- [views/task/TaskList.vue](file://frontend/src/views/task/TaskList.vue#L75-L124)
- [views/task/TaskForm.vue](file://frontend/src/views/task/TaskForm.vue#L128-L182)
- [api/connection.ts](file://frontend/src/api/connection.ts#L14-L16)
- [api/risk.ts](file://frontend/src/api/risk.ts#L47-L49)
...
## 依赖关系分析
- 技术栈：Vue 3、TypeScript、Element Plus、Vue Router、Pinia、Axios、ECharts、SockJS/STOMP（用于 WebSocket，见 package.json）
...
- [vite.config.ts](file://frontend/vite.config.ts#L8-L29)
- [main.ts](file://frontend/src/main.ts#L1-L23)
...
章节来源
- [router/index.ts](file://frontend/src/router/index.ts#L9-L94)
- [views/Dashboard.vue](file://frontend/src/views/Dashboard.vue#L111-L158)
- [views/task/TaskList.vue](file://frontend/src/views/task/TaskList.vue#L75-L90)
...
## 结论
该前端应用以 Vue 3 + TypeScript 为基础，结合 Element Plus、Pinia、Vue Router 与 Axios，形成了清晰的分层架构与良好的可维护性。通过统一的 API 封装与状态管理，实现了登录态与权限控制；页面组件围绕业务域组织，具备良好的复用性与扩展性。建议后续持续完善权限体系、增加错误边界与加载状态、引入国际化与主题切换等能力，进一步提升用户体验与可维护性。
