...
- [AlertList.vue](file://frontend/srcviews/alert/AlertList.vue)
...
## 更新摘要
**所做更改**
- 更新了任务表单组件部分，反映强制全表扫描开关、抽样条数和大表阈值配置的新功能
- 添加了新的配置界面设计说明和用户交互流程
- 增强了任务管理的配置选项和用户体验
...
**更新** 本次更新重点关注任务表单组件的增强功能，包括强制全表扫描开关、抽样条数配置和大表阈值设置等新特性。
...
**图表来源**
- [TaskForm.vue](file://frontend/src/views/task/TaskForm.vue#L29-L40)
- [TaskForm.vue](file://frontend/src/views/task/TaskForm.vue#L116-L118)
...
**章节来源**
- [TaskForm.vue](file://frontend/src/views/task/TaskForm.vue#L1-L195)
- [api/task.ts](file://frontend/src/api/task.ts#L3-L20)
...
**更新** 最新版本的任务表单组件增强了配置灵活性，用户可以通过强制全表扫描开关、抽样条数和大表阈值等配置来精确控制检查行为，提升了系统的适用性和用户体验。
